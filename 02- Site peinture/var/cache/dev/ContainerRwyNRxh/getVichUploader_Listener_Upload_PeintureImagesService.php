 ...
 */
class getVichUploader_Listener_Upload_PeintureImagesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.upload.peinture_images' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['vich_uploader.listener.upload.peinture_images'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('peinture_images', new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter(), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), ($container->services['vich_uploader.upload_handler'] ?? $container->load('getVichUploader_UploadHandlerService')));
    }
}
