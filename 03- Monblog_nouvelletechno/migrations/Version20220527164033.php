 ...
 */
final class Version20220527164033 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categories CHANGE slug slug VARCHAR(60) NOT NULL');
        $this->addSql('DROP INDEX UNIQ_D4E4C6CA989D9B62 ON mots_cles');
        $this->addSql('ALTER TABLE mots_cles CHANGE slug slug VARCHAR(60) NOT NULL');
